...
6. Track **rounding policy** (keep extra digits; round only at the end unless specified).
7. If ambiguity exists (e.g., “MB” vs “MiB”), **branch** into cases and label.
8. Provide a **sanity-range** check (order-of-magnitude).
9. Keep **consistent sig figs** across reported outputs.
